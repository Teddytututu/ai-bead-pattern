...
import { applyStyle, resizePixels, samplePixelsAtSourceMapping } from '../image.js'
import { optimizePaletteAssignments } from '../palette-optimization.js'
import { refineGridClusters } from '../grid-refinement.js'
import { resolveFeatureColors, buildStructurePlan, buildValuePlan, buildPalettePlan, quantizePalette, enforcePaletteInventory, styleColorLimit, type ResolvedFeaturePlacement, type ResolvedOccupancyMode } from '../planning/index.js'
