...
PROVIDER_ID = "openclip-vit-b32-pair-local"
MODEL_NAME = "ViT-B-32"
PRETRAINED_TAG = "laion2b_s34b_b79k"
WEIGHT_REPOSITORY = "laion/CLIP-ViT-B-32-laion2B-s34B-b79K"
WEIGHT_FILENAME = "open_clip_pytorch_model.bin"
WEIGHT_REVISION = "1a25a446712ba5ee05982a381eed697ef9b435cf"
...
MODEL_DESCRIPTOR = {
    **MODEL_IDENTITY,
    ...
    "weightSource": (
        ...
        f"{WEIGHT_REPOSITORY}/tree/{WEIGHT_REVISION}"
    ),
    "license": {
        "spdx": "MIT",
    ...
    "weightLicense": {
        ...
        "url": (
            "https://huggingface.co/"
            f"{WEIGHT_REPOSITORY}/blob/{WEIGHT_REVISION}/README.md"
        ),
    },
    "input": {
        "width": 224,
